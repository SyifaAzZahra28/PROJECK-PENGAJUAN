...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="{{ asset('guruable2-01.0') }}/assets/images/favicon.ico" type="image/x-icon">
    <!-- Google font-->
                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form class="md-float-material">
                            <div class="text-center">
                                <h1 class="text-dark">SchoolApprovalHub</h1>
                            </div>
                            <div class="auth-box">
                                ...
                                <div class="input-group">
                                    <select class="form-select form-control form-control-round">
        ...
        <ul class="iew-download">
            <li>
                <a href="http://www.google.com/chrome/">
                    <img src="  {{ asset('guruable2-01.0') }}/assets/images/browser/chrome.png" alt="Chrome">
                    <div>Chrome</div>
                </a>
            </li>
            <li>
                <a href="https://www.mozilla.org/en-US/firefox/new/">
                    <img src="  {{ asset('guruable2-01.0') }}/assets/images/browser/firefox.png" alt="Firefox">
                    <div>Firefox</div>
                </a>
            </li>
            <li>
                <a href="http://www.opera.com">
                    <img src="  {{ asset('guruable2-01.0') }}/assets/images/browser/opera.png" alt="Opera">
                    <div>Opera</div>
                </a>
            </li>
            <li>
                <a href="https://www.apple.com/safari/">
                    <img src="  {{ asset('guruable2-01.0') }}/assets/images/browser/safari.png" alt="Safari">
                    <div>Safari</div>
                </a>
            </li>
            <li>
                <a href="http://windows.microsoft.com/en-us/internet-explorer/download-ie">
                    <img src="  {{ asset('guruable2-01.0') }}/assets/images/browser/ie.png" alt="">
                    <div>IE (9 & above)</div>
                </a>
            </li>
        </ul>
...
<![endif]-->
    ...
    <script type="text/javascript" src="{{ asset('guruable2-01.0') }}/assets/js/modernizr/css-scrollbars.js"></script>
    <script type="text/javascript" src="{{ asset('guruable2-01.0') }}/assets/js/common-pages.js"></script>
</body>
