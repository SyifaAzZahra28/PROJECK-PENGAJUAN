                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <div class="card-block">
                                                            <h4 class="sub-title">Edit Pengajuan</h4>
                                                            <div>
                                                                <a href="/user/submissions"><button class="btn btn-primary btn-outline-primary btn-round">Batal</button></a>
                                                            </div>
                                                            <br>
                                                            <form>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-10">
                                                                    <a href="/user/submissions"><button class="btn btn-primary btn-outline-primary btn-round">Simpan</button></a>
                                                                </div>
                                                            </div>
                                                                        <!-- Page body end -->
    </div>
