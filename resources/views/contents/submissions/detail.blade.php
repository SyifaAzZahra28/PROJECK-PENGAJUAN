                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <div class="card-block">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-10">
                                                                    <a href="/user/submissions"><button class="btn btn-success btn-outline-success btn-round">Disetujui</button></a> <a href="/admin/agreement/rejected"><button class="btn btn-danger btn-outline-danger btn-round">Ditolak</button></a>
                                                                </div>
                                                            </div>
    </div>
</div>
